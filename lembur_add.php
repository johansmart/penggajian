...
if(isset($_POST['btnSimpan'])){
	...
	$mySql  	= "INSERT INTO lembur (kd_pegawai, tanggal, keterangan, kd_user)
					VALUES ('$cmbPegawai', '$txtTanggal', '$txtKeterangan', '$userLogin')";
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="100%" class="table-list" border="0" cellspacing="1" cellpadding="4">
    <tr>
      <th colspan="3"><b>TAMBAH DATA LEMBUR </b></th>
    </tr>
    <tr>
